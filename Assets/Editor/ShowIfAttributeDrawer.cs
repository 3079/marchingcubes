...
public class ShowIfAttributeDrawer : PropertyDrawer
{
    ...
    private bool MeetsConditions(SerializedProperty property)
    {
        ...
        var target = (GameObject)property.serializedObject.targetObject;
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        if (showIfAttribute != null && !meetsCondition && showIfAttribute.Action == ActionOnConditionFail.Hide)
            return 0;
           ...
           label)
    {
        ...
        var showIfAttribute = this.attribute as ShowIfAttribute;
        if(showIfAttribute.Action == ActionOnConditionFail.Hide)
        {
            return;
        }
